...
public class ViewToController {
	...
	public String transfer1(HttpServletRequest request) throws Exception{
		
		MemberDTO memberDTO = new MemberDTO();
		memberDTO.setId(request.getParameter("id"));
		memberDTO.setPw(request.getParameter("pw"));
		memberDTO.setName(request.getParameter("name"));
		memberDTO.setGender(request.getParameter("gerder"));
		...
		return "redirect:/cTOv/list1";  //정말 중요한 문단
	}
	/*
	 *
	...
	public String transfer2(MemberDTO memberDTO) throws Exception{
	...
	public String transfer3(@RequestParam Map<String,String> memberMap) throws Exception{
 ...
 */
	...
	public String transfer4(@RequestParam(name = "id"   , defaultValue = "anonymous") String id ,
						    ...
						    @RequestParam(name = "name" , defaultValue = "anonymous") String name)throws Exception {
	...
	public String transfer5(String id, String pw, String name)throws Exception {
