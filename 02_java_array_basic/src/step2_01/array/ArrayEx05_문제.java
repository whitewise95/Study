...
public class ArrayEx05_문제 {
	...
	Scanner scan = new Scanner(System.in);
		...
		if(number1 == 0) System.out.println(arr[0]);
		if(number1 == 1) System.out.println(arr[1]);
		if(number1 == 2) System.out.println(arr[2]);
		if(number1 == 3) System.out.println(arr[3]);
		if(number1 == 4) System.out.println(arr[4]);
