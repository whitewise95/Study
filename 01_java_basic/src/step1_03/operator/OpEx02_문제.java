...
public class OpEx02_문제 {
	...
	public static void main(String[] args) {
		...
		//문제1) 월급이 100원이다. 연봉은? (조건 : 세금 10% 제외)
		   double salary = (100*12)*0.9;
		  System.out.println("연봉 세후 : "+salary);
		
		//문제2) 시험점수를 30, 50, 4점 을 받았다. 평균은?
		 double score = (30+50+4)/3;
		...
		System.out.println(100/60+"분");
		System.out.println(100%60+"초");
		System.out.println((100/60)+"분"+ (100%60)+"초");
		System.out.println("1분40초");
		
		//문제5) 800원에서 500원짜리 개수 , 100원짜리 개수 출력
		//정답5) 500원(1개), 100원(3개)
		System.out.println("500원 개수 : "+ 800/500+"개");
        System.out.println("100원 개수 : "+ 800%500+"개");
	}
